...
- <h3>Lattice thermal conductivity using Phono3py</h3>
  ...
  reported. There being no definitive guide to calculating <b>&kappa;<sub>L</sub></b> using Phono3py, here I list out some common pitfalls   and summarize the way to carry out calculations. <a href=http://s-utkarsh.github.io/_posts/k_lattice>Read More..</a>
